...
from ..builder import REGRESSIONS, build_backbone, build_head, build_neck
from ..utils.augment import Augments
from .base import BaseRegression


@REGRESSIONS.register_module()
class ImageRegression(BaseRegression):
    ...
    def __init__(self,
                 ...
                 train_cfg=None,
                 init_cfg=None):
        super(ImageRegression, self).__init__(init_cfg)
    ...
    def forward_train(self, img, gt_label, **kwargs):
        ...
        Args:
            ...
            gt_label (FloatTensor): It should be of shape (N, 1) encoding the
                ground-truth label of input images for regression task.
        Returns:
